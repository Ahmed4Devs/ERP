...
import { Plus, Search, Receipt, CheckCircle2, Clock, Eye, ShoppingCart, Printer } from 'lucide-react';
                                    ...
                                    <tr key={quote.id} className="hover:bg-neutral-50/50 dark:hover:bg-neutral-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-end">
                                            <div className="flex items-center justify-end gap-1">
                                                <Button asChild variant="ghost" size="sm" className="h-8 w-8 p-0 text-neutral-600 dark:text-neutral-400 hover:text-indigo-600" title={isRtl ? 'طباعة عرض السعر' : 'Print Quotation'}>
                                                    <a href={`/sales/quotations/${quote.id}/print`} target="_blank" rel="noopener noreferrer">
