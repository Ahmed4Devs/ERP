...
| M1 — Platform Foundation | Authentication, MFA, Tenancy, Companies, Branches, RBAC, Bilingual Shell, Party CRUD, Negative isolation tests | Working login, tenant/company switcher, party CRUD, negative Pest tests | In Progress |
| M2 — Accounting & Service Revenue | Accounts, periods, exact posting engine, service invoices, receipts, allocations, trial balance, AR aging | Service invoice-to-receipt cycle, balancing journals, PDF/print rendering | Planned |
